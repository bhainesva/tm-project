...
public class Demo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        StanfordCoreNLP pipeline = new StanfordCoreNLP(props);
        //StanfordCoreNLPClient pipeline = new StanfordCoreNLPClient(props, "localhost", 9000, 8);
        ...
        if (args.length > 0) {
            ...
            annotation = new Annotation("A meeting of the Federal Open Market Committee was held in the offices of the Board of Governors of the Federal Reserve System in Washington, D.C., on Tuesday, April 24, 2012, at 1:00 p.m., and continued on Wednesday, April 25, 2012, at 8:30 a.m.\n" +
                    "\n" +
                    "PRESENT:\n" +
        ...
        System.out.println("\nRan in " + (endTime - startTime) / 1000.0 + " seconds");
